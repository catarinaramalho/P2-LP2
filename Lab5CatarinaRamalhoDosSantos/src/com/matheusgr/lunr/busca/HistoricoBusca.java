...
public class HistoricoBusca {
	...
	private BuscaInterface buscaInterface;
	 ...
	 */
	public HistoricoBusca(BuscaInterface buscaInterface, String[] documentosIds) {
		this.buscaInterface = buscaInterface;
	 ...
	 */
	public String[][] debug() {
		return this.buscaInterface.descreveConsulta();
	}
